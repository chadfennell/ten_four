defmodule TenFourWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TenFourWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TenFourWeb.Gettext, "errors", msg, opts)
    end
  end
